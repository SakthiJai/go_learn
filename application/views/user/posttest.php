			...
			<div class="mdc-layout-grid__inner">
				<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
					<div class="mdc-card">
						...
						<?php $i=1; $program_id =0;foreach($post_test_list->result() as $row) { $program_id= $row->program_id;?>
						<input type="hidden" name="program_id" value="<?php echo $row->program_id;?>">
						<?php } ?>

						<div class="col-12 grid-margin">
							<div class="card card-statistics">
							   <?php if ($post_test_sub->count2 > 0 && $post_test_sub->test_type1 == 2) { ?>
								  ...
								  <div class="ssss">
									<table class="gdtdnd">
										...
										foreach ($post_test_result->result() as $row) { ?>
											<?php if ($row->test_id && $row->test_type1 == 2) { ?>
												<tr class="ynvxmx">
							  ...
							  <?php } else {  ?>
								<form action="<?php echo base_url("index.php/Test/exam");?>" method="POST"
									...
									<?php $i=1; foreach($post_test_detail->result() as $row) { ?>

									<div class="row">
										<input type="hidden" name="test_type" id="test_type" value="2">
