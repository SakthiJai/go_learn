                ...
                <div class="mdc-card">
                  <div class="d-flex justify-content-between">
					...
					<button class="mdc-button mdc-button--outlined outlined-button--secondary mdc-ripple-upgraded" style="--mdc-ripple-fg-size:65px; --mdc-ripple-fg-scale:1.92333; --mdc-ripple-fg-translate-start:-21.6875px, -3.5px; --mdc-ripple-fg-translate-end:22.1188px, -14.5px;">
					   ...
					   <a class="mdc-button mdc-button--raised filled-button--secondary mdc-ripple-upgraded" href="http://localhost/superadmin/main/addemp" style="--mdc-ripple-fg-size:83px; --mdc-ripple-fg-scale:1.85659; --mdc-ripple-fg-translate-start:4.19446px, -34.5px; --mdc-ripple-fg-translate-end:28.2639px, -23.5px;">
                                    New Employee
                                </a>
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12 mdc-layout-grid__cell--span-8-tablet">
                        <div class="table-responsive border">
						  ...
						  <thead>
                            ...
                            <tbody>
							<?php  $i=1;foreach($emp_history as $row) { ?>
										  <tr>
												<td><?php echo $i;?></td>
