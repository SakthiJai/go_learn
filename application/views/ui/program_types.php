                                ...
                                <?php foreach ($program_types->result() as $row) { ?>
                                    <tr>
                                        ...
                                        <td style='text-align: center;'><?php echo $row->type; ?></td>
										 <td style='text-align: center;'><a href="<?php echo base_url(); ?>main/program_types/<?php echo $row->id; ?>"  class="mdc-button mdc-button--raised icon-button filled-button--success mdc-ripple-upgraded" style="--mdc-ripple-fg-size:21px; --mdc-ripple-fg-scale:2.90056; --mdc-ripple-fg-translate-start:12.375px, 18.5px; --mdc-ripple-fg-translate-end:7.5px, 7.5px; background-color: #00bbdd;">
