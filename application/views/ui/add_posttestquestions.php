<div class="app-main__outer  table-responsive">
    <div class="app-main__inner" >
                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <form class="" action="<?php echo base_url();?>superadmin/posttestquestions_adding/<?php echo $c_id; ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="d-block text-center"> <h6> <strong> </strong></h6></div>
                    <?php $i=1; foreach($questions->result() as $row)  { ?>
                    <div class="card-body">
