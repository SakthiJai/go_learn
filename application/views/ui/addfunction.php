                ...
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                      ...
                      <div class="menu-button-container">
                        <div class="mdc-card">
						        <?php if (isset($editfunction) && ($editfunction->num_rows() > 0)) {
            foreach ($editfunction->result() as $row) { ?>
                  <form  id="employee" class="" action="<?php echo base_url(); ?>main/updatefunction/<?php echo $row->id; ?> " method="POST">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100 mdc-ripple-upgraded">           
							...
							<input class="mdc-text-field__input" id="text-field-hero-input exampleText" name="function"  value="<?php echo $row->function;?>"  >
                          </div>
                        </div>
