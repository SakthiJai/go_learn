                ...
                <div class="mdc-card">
                  <div class="d-flex justify-content-between">
                   <button class="mdc-button mdc-button--outlined outlined-button--secondary mdc-ripple-upgraded" style="font-size: 12px;--mdc-ripple-fg-size:95px; --mdc-ripple-fg-scale:1.82773; --mdc-ripple-fg-translate-start:-36.7px, -39.1px; --mdc-ripple-fg-translate-end:32.3125px, -29.5px;">
                    ...
                    <div>
					 <a  style="font-size: 12px;" class="mdc-button mdc-button--raised filled-button--secondary mdc-ripple-upgraded" href="<?php echo base_url('main/adddesignation'); ?>">
                                    New Designation
                                </a>&nbsp;&nbsp;
							...
							<?php $i=1; foreach($designation_master->result() as $row) { ?>
                                      <tr style="background: white;">
                                            ...
                                            <td style='text-align: center;'><?php echo $row->designation;?></td>
											 <td style='text-align: center;'><a href="<?php echo base_url(); ?>main/designation_master/<?php echo $row->id; ?>"  class="mdc-button mdc-button--raised icon-button filled-button--success mdc-ripple-upgraded" style="background-color: #00bbdd;padding: 2%;text-decoration:none">
