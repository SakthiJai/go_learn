                ...
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                      ...
                      <div class="menu-button-container">
                        <div class="mdc-card">
						   <?php if (isset($editgrade) && ($editgrade->num_rows() > 0)) {
            foreach ($editgrade->result() as $row) { ?>
                  <form  id="employee" class="" action="<?php echo base_url(); ?>main/updategrade/<?php echo $row->id; ?>" method="POST">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
				   ...
				   <?php } ?>   <?php }else { ?>
				   <form  id="employee" class="" action="<?php echo base_url('main/addgrade_master');?>" method="POST">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
					 <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100 mdc-ripple-upgraded">
