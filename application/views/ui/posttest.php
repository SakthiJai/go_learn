        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>L3 - Post Test
                        <div class="page-title-subheading">PostTest</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="main-card mb-3 card">
                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable-buttons" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php $i = 1;
                                            foreach ($posttestlist->result() as $row) {  ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    ...
                                                    <td><a href="<?php echo base_url('questions/postquestion/'.$row->id);?>"  class="btn btn-success">Add Questions</a></td>
									    	     	<td><a href="<?php echo base_url('questions/postquestion/'.$row->id);?>"  class="btn btn-success">View</a></td>
									    	        	<?php $id1 =  $row->id;?>
                                                </tr>
                                            <?php $i++;
                                            } ?>
