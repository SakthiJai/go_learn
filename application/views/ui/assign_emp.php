                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <form class=""  action="<?php echo base_url('superadmin/assign_emp/'.$program_id);?>" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-10">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body  table-responsive">
						...
						<div class="col-sm-12" id="button_div" ><button type="submit" class="btn btn-warning">Assign</div>
                    </div>
                    </form>
                </div>
            </div>
