        ...
        <main class="content-wrapper">
          <div class="mdc-layout-grid">
            ...
            foreach ($editbranch->result() as $row) { ?>
                      ...
                      <div class="mdc-layout-grid__inner">
						 ...
						 <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100 mdc-ripple-upgraded">
							...
							<input class="mdc-text-field__input" id="text-field-hero-input exampleText" name="branch_plant" value="<?php echo $row->branch;?>" >								
                          </div>
                        </div>
                        <div class="mdc-3 ayout-grid__cell stretch-card mdc-layout-grid__cell--span-2">
                          <button class=" mt-4 btn btn-primary mdc-button mdc-button--raised filled-button--success mdc-ripple-upgraded vertical-center" style="--mdc-ripple-fg-size:56px;     --mdc-ripple-fg-scale:1.96936; --mdc-ripple-fg-translate-start:22.9px, -19.6px; --mdc-ripple-fg-translate-end:18.8px, -10px ,float:   ">
							...
							<a href="<?php echo base_url('main/branch_master'); ?>" class="  mt-4 mdc-button mdc-button--raised filled-button--secondary mdc-ripple-upgraded" style="--mdc-ripple-fg-size:70px; --mdc-ripple-fg-scale:1.90907; --mdc-ripple-fg-translate-start:8.11121px, -9.33333px; --mdc-ripple-fg-translate-end:24.1389px, -17px;   ">
                                  Cancel
                                </a>
                        </div>
				  ...
				  <?php } ?>   <?php }else { ?>
				  <form  id="employee" class="" action="<?php echo base_url('main/addbranch_master');?>" method="POST">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
						 ...
						 <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div class="mdc-text-field w-100 mdc-ripple-upgraded">
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">Branch/Plant</label>
							<input class="mdc-text-field__input" id="text-field-hero-input exampleText" name="branch_plant"  >								
                          </div>
                        </div>
