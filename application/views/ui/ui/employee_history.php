                                ...
                                <div class="main-card mb-3 card ">
                                    <div class="card-body table-responsive">
                                      ...
                                      <tr>
                                            ...
                                            <td><?php if($row->resignation_date!='0000-00-00'){ echo $row->resignation_date; }else{ echo "";  } ?></td>
                                            <td><?php if($row->emp_status=='2'){ echo "Resigned"; }  ?></td>
                                            <td><?php echo date('d-m-Y H:i:s ', strtotime($row->created_datetime));?></td>
                                        </tr>
										<?php $i++;   }  ?>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/employee_histroy.js"></script>
</body>
