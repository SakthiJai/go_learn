        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>Post Test
                        <div class="page-title-subheading">Add Test Questions123</div>
                    </div>
                </div>
            </div>
        </div> 
                    ...
                    <div class="col-md-12">
                            <?php if(($this->uri->segment(4)=="")){?>
                                <div class="card-box">
                                    ...
                                    <form id="questions" action="<?php echo base_url('questions/addpostquation');?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
